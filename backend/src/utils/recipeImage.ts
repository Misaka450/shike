import localVerifiedRecipes from '../data/localVerifiedRecipes.json' with { type: 'json' };
 ...
 */
export const LOCAL_VERIFIED_RECIPES: Record<string, string> = localVerifiedRecipes;
